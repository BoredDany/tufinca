...
public class ModelMapperConfiguration {
        ...
        public ModelMapper modelMapper() {
                ...
                // Mapping for BankAccount to BankAccountDTO
                modelMapper.typeMap(BankAccount.class, BankAccountDTO.class).addMappings(mapper -> {
                        mapper.map(BankAccount::getIdAccount, BankAccountDTO::setIdAccount);
                        mapper.map(BankAccount::getBank, BankAccountDTO::setBank);
                        mapper.map(BankAccount::getAccountNumber, BankAccountDTO::setAccountNumber);
                        mapper.map(src -> src.getUser().getIdUser(), BankAccountDTO::setIdUser);
                });

                // Mapping for BankAccountDTO to BankAccount
                modelMapper.typeMap(BankAccountDTO.class, BankAccount.class).addMappings(mapper -> {
                        mapper.map(BankAccountDTO::getIdAccount, BankAccount::setIdAccount);
                        mapper.map(BankAccountDTO::getBank, BankAccount::setBank);
